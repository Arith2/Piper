...
create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name ila_network_top_perf
set_property -dict [list CONFIG.C_PROBE5_WIDTH {64} CONFIG.C_PROBE4_WIDTH {64} CONFIG.C_PROBE3_WIDTH {64} CONFIG.C_PROBE2_WIDTH {64} CONFIG.C_DATA_DEPTH {1024} CONFIG.C_NUM_OF_PROBES {6} CONFIG.Component_Name {ila_network_top_perf} CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_ADV_TRIGGER {true} CONFIG.C_INPUT_PIPE_STAGES {1} CONFIG.C_PROBE5_MU_CNT {8} CONFIG.C_PROBE4_MU_CNT {8} CONFIG.C_PROBE3_MU_CNT {8} CONFIG.C_PROBE2_MU_CNT {8} CONFIG.C_PROBE1_MU_CNT {2} CONFIG.C_PROBE0_MU_CNT {2} CONFIG.ALL_PROBE_SAME_MU {false} CONFIG.ALL_PROBE_SAME_MU_CNT {2}] [get_ips ila_network_top_perf]
