...
void DecodeFilter(
    ...
    do {
        ...
        if (second_output_flag) {
            ...
            output_data_32 = (neg_meta_1==1) ? output_data_neg_1 : input_data_1;
            // stream_out.write(output_data_32);
            output_counter++;
        }
        else if (third_output_flag) {
            third_output_flag = false;
            // output_data_32 = input_data_2;
            // stream_out.write(0);
            output_counter++;
        }
        else if (forth_output_flag) {
            forth_output_flag = false;
            // output_data_32 = input_data_3;
            // stream_out.write(0);
            output_counter++;
        }
            ...
            if (input_data == end_of_text_input) {
                // stream_out.write(end_of_text_data);
                read_loop++;
                std::cout << "input_counter: " << input_counter << ", output_counter: " << output_counter << std::endl;

                // std::cout << "binary_counter: " << binary_counter << std::endl;
            }
            else {
                if (output_meta == 0b1111) {
                    forth_output_flag = true;
                    third_output_flag = true;
                    second_output_flag = true;
                }
                else if (output_meta == 0b0111) {
                    third_output_flag = true;
                    second_output_flag = true;
                }
                ...
                output_data_32 = (neg_meta_0==1) ? output_data_neg_0 : input_data_0;
                // stream_out.write(output_data_32);
                output_counter++;
