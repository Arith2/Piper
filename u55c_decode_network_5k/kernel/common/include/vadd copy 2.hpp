    ...
    do {
        ...
        if (!stream_in.empty()) {
            ...
            if (input_data == end_of_text) {
                ...
                read_loop++;
                std::cout << "output_counter: " << output_counter << std::endl;
            }
            else {
    ...
    do {
        ...
        if (second_output_flag) {
            ...
            if (input_data == end_of_text_data) {
                ...
                // if (binary_counter < 14) {
                //     std::cout << input_data_0 << " ";
                // }
                // else {
                //     std::cout << std::hex << input_data_0 << std::dec << " ";
                // }   
                
                // if (binary_counter <= 39) {
                //     binary_counter++;
                // }
                // else {
                //     binary_counter = 0;
    ...
    do {
        ...
        if (!stream_in.empty()) {
            ...
            if (input_data == end_of_text_data) {
                ...
                std::cout << "read_loop: " << read_loop << ", output_counter: " << output_counter << std::endl;
...
void ConsumeStream(
    ...
    do {
        ...
        if (!stream_in.empty()) {
            ...
            if (input_data == end_of_text_data) {
                read_loop++;
                std::cout << "final ddr_index: " << std::dec << ddr_index << std::endl;
            }
            else {
                table_DDR[ddr_index] = input_data(31, 0);
                ddr_index++;
            }
        }
    }while(read_loop < 2);
